...
API for unifying public API resources used for the educational geography application Worldly. Uses APIs from Wikipedia and <a href="https://restcountries.com/"  target="_blank"> REST Countries. </a>
